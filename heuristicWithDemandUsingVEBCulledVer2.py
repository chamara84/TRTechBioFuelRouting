...
for i in range(len(Cost)):
    Cost[i]=L1_distance[i]/1000.*L1_weight+highway_distance/1000.*highway_weight+harvest_cost[i]
...
while len(testSet)>0:
    bestStorageAllocation,prevMinSol,bestSourceToDestAlloc =  findAllocationForGivenActiveStorages(testSet,prevMinSol,prevBestStorage,costPerTonArrayAscend,fixedCostStorage,availability,demand,B_ij,treeArray,T_min)     
    testSet.clear()
