...
file_ = open("/home/chamara/Dropbox/TRTech/Chamara/IISDoptWithFixed.csv","r")
...
with open('/home/chamara/Dropbox/TRTech/Chamara/IISDRoadSide150TwoStoresWithFixed.csv', 'w') as IISD_optVar:
        datawriter = csv.writer(IISD_optVar, delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open('/home/chamara/Dropbox/TRTech/Chamara/IISDRoadSide152TwoStoresWithFixed.csv', 'w') as IISD_optVar:
        datawriter = csv.writer(IISD_optVar, delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open('/home/chamara/Dropbox/TRTech/Chamara/IISDRoadSide1027TwoStoresWithFixed.csv', 'w') as IISD_optVar:
        datawriter = csv.writer(IISD_optVar, delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
...
with open('/home/chamara/Dropbox/TRTech/Chamara/IISDRoadSide1225TwoStoresWithFixed.csv', 'w') as IISD_optVar:
        datawriter = csv.writer(IISD_optVar, delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
